...
RSS_FEEDS = [
    ...
    ("https://datainsight.ru/rss.xml", "Data Insight")
]
...
# Юридические ключевые слова для фильтрации новостей
LEGAL_KEYWORDS = [
    'суд', 'арбитраж', 'вс рф', 'верховный суд', 'закон', 'постановление',
    'право', 'юрист', 'штраф', 'компенсация', 'потребитель',
    'маркетплейс', 'комиссия', 'возмещение', 'иск', 'ответственность'
]
