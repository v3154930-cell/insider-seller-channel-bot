...
LAYERS = ("news_signal", "official_signal", "legal_official", "tariff_official", "marketplace_offer", "analytics_periodic", "docobrazec_base", "offer_doctor_base", "internal_rule")
...
SEEDS = [
    ...
    ("yandex_market_seller_docs_official", "Yandex Market seller docs", "official", "https://yandex.ru/support/marketplace/", "yandex_market", "seller marketplace docs", "marketplace_offer", "high", "official_docs", "planned", "manual_fetch", "Official source candidate; dry-run output must be reviewed before ingestion."),
    ("ozon_seller_news_official", "Ozon seller news", "official", "https://seller.ozon.ru/news/", "ozon", "seller marketplace news", "marketplace_offer", "high", "official_news", "planned", "manual_fetch", "Official source candidate; dry-run output must be reviewed before ingestion."),
    ("wildberries_seller_news_official", "Wildberries seller news", "official", "https://seller.wildberries.ru/news/", "wildberries", "seller marketplace news", "marketplace_offer", "high", "official_news", "planned", "manual_fetch", "Official source candidate; may render dynamically; review dry-run output before ingestion."),
    ("pravo_legal_publication_portal", "Official legal publication portal", "official", "https://pravo.gov.ru/", "multiple", "official legal publications", "legal_official", "high", "legal_publication", "planned", "manual_fetch", "Official legal publication source candidate; review dry-run output before ingestion."),
]
